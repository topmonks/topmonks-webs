...
export function installationGuide() {
  return html`
    ...
    <div class="step_1 mdc-layout-grid__cell mdc-layout-grid__cell--span-8-tablet">
      ...
      <p class="grey-text">
        ...
        <a
          ...
          class="text--purple">Apple App Store</a>
    ...
    <div class="step_2 mdc-layout-grid__cell mdc-layout-grid__cell--span-8-tablet">
      ...
      <p class="grey-text">V pravo klikněte na tlačítko Získat, potom Nainstalovat, potom kliknete na ikonku stáhnout, potom na tlačítko Otevřít.</p>
    </div>
    <div class="step_3 mdc-layout-grid__cell mdc-layout-grid__cell--span-8-tablet">
      ...
      <p class="grey-text">
        ...
        Dokončit nastavení. Poté se vám otevře okno Nastavení v Safari, kde musíte
        povolit Hlídače shopů pomocí zaškrtnutí.
      </p>
    </div>
    <div class="final-step mdc-layout-grid__cell mdc-layout-grid__cell--span-12">
      ...
      <div class="btn">
        <a
          ...
          class="button"
          role="button"
          href="https://apps.apple.com/us/app/hl%C3%ADda%C4%8D-shop%C5%AF/id1488295734">Nainstalovat do prohlížeče</a>
      </div>
    </div>
  `;
}
